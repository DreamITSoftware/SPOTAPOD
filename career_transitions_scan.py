#!/usr/bin/env python3
"""
career_transitions_scan.py

Counts mentions of career-transition-related terms (layoffs, remote
work, return to office, burnout, work-life balance) across post content
...
Usage:
    python3 career_transitions_scan.py podawaa /path/to/podawaa2024.json
    python3 career_transitions_scan.py hyperclapper /path/to/HyperClaper.json
    python3 career_transitions_scan.py linkboost /path/to/LinkBoost-2025.json
"""
import sys
import json
import argparse
...
TERMS = {
    "layoffs": r"\blayoffs?\b|\blaid off\b",
    "remote work": r"\bremote work\b|\bwork from home\b|\bWFH\b",
    "return to office / RTO": r"\breturn to office\b|\bRTO\b|\bback to office\b",
    "burnout": r"\bburnout\b|\bburned out\b|\bburnt out\b",
    "work-life balance": r"\bwork-life balance\b|\bwork life balance\b",
}
...
def scan(texts, label, n):
    ...
    print(f"Records mentioning any career-transition term: {any_hit:,} ({any_hit/n*100:.3f}%)")
