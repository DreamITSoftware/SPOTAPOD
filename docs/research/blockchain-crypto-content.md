...
dataset, roughly 4x HyperClaper's rate and 2.5x LinkBoost-2025's. This
...
(2,971 mentions). HyperClaper and LinkBoost-2025 both lean toward
"crypto/cryptocurrency" as the dominant phrasing instead.

**A plausible, but not confirmed, cross-dataset pattern**: podawaa2024
is 2024 data, while HyperClaper and LinkBoost-2025 are 2025-2026 data.
...
podawaa2024 to 27.97% in HyperClaper, per
