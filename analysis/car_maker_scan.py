...
Counts mentions of major automaker names across post content in all
...
Distinct from entity-mentions.md's general corporation-mention scan --
this focuses specifically on automakers, at a finer resolution than
that broader scan tracks.

Usage:
    python3 car_maker_scan.py podawaa /path/to/podawaa2024.json
    python3 car_maker_scan.py hyperclapper /path/to/HyperClaper.json
    python3 car_maker_scan.py linkboost /path/to/LinkBoost-2025.json
"""
import sys
import json
import argparse
...
TERMS = {
    ...
    "Rivian": r"\bRivian\b",
    "Lucid Motors": r"\bLucid Motors\b",
}
...
def scan(texts, label, n):
    ...
    print(f"Records mentioning any car maker: {any_hit:,} ({any_hit/n*100:.3f}%)")
